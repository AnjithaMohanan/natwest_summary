...
import StateDetailComponent from './StateDetailComponent'; 
...
const CustomTooltip = ({ active, payload }) => {
  if (active && payload && payload.length) {
    ...
    return (
      <div style={{ background: '#green', padding: '10px', border: '1px solid #ccc', fontSize:"10px" }}>
        <p>{`State: ${data.name}`}</p>
